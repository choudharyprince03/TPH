...
export default function MyPropertyWorldPage() {
  ...
  const [activeRailTab, setActiveRailTab] = useState<"overview" | "properties" | "trust" | "messages">("overview");

  return (
    <div className="w-full flex-1 flex flex-col bg-[#f4f6f8] text-[#102645]">
      
      {/* Shell with Left Navigation Rail + Workspace Content */}
      <div className="max-w-[1512px] mx-auto w-full grid grid-cols-1 lg:grid-cols-[230px_minmax(0,1fr)] min-h-[calc(100vh-108px)]">

        {/* ── LEFT RAIL (Prototype signature sidebar) ───────────────────── */}
        <aside className="bg-white border-r border-[#dfe6ef] p-6 lg:p-7 flex flex-col gap-6 sticky top-[78px] h-[calc(100vh-78px)] overflow-y-auto">
          ...
          <nav className="grid gap-1.5 text-[12px] font-medium" aria-label="My Property World">
            ...
            <button
              onClick={() => setActiveRailTab("properties")}
              className={`w-full flex items-center gap-3 px-3.5 py-2.5 rounded-lg text-left transition-all ${
        ...
        <main className="p-6 sm:p-9 lg:p-11 max-w-[1240px] w-full">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 bg-white border border-[#cbd5e2] hover:bg-[#f3f6fb] text-[#102645] px-4 py-2.5 rounded-xl text-[12px] font-semibold transition-colors shadow-sm self-start sm:self-auto"
            >
              <span>+ Add a property</span>
            </button>
          </div>

          {/* ── Handover Ready Hero Banner (from Hart Homes) ────────────── */}
          <section className="bg-[#071d3b] text-white rounded-2xl p-6 sm:p-8 mb-9 relative overflow-hidden shadow-[0_12px_40px_rgba(7,29,59,0.08)] flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
            ...
            <div className="hidden lg:block w-48 h-36 rounded-xl overflow-hidden shadow-md flex-shrink-0 border border-white/20">
              <img
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-7 mb-10">
            ...
            <section className="bg-white border border-[#dfe6ef] rounded-2xl p-6 shadow-sm">
              ...
              <div className="divide-y divide-[#dfe6ef]">
                {/* Attention Row 1: Review Handover */}
                ...
                {/* Attention Row 2: Message from Olivia */}
                <div className="py-3.5 flex items-center gap-3.5">
            ...
            <section className="bg-white border border-[#dfe6ef] rounded-2xl p-6 shadow-sm">
              ...
              <div className="divide-y divide-[#dfe6ef]">
                <button
                  onClick={() => alert("Add a Document: Upload warranties, receipts or certificates to keep them in your Prop ID.")}
          ...
          {/* ── Your Properties Section (Grid 2/3) ─────────────────────── */}
          <section className="mb-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              {/* Property 1: 18 Banksia Crescent */}
              <article className="bg-white border border-[#dfe6ef] rounded-2xl overflow-hidden shadow-sm flex flex-col justify-between">
                <div className="relative h-44 bg-[#e4eaf0]">
                  <img
                    src="/images/hero-real-estate.jpg"
                    alt="18 Banksia Crescent"
                    className="w-full h-full object-cover"
                  />
                  <span className="absolute bottom-3 left-3 bg-white px-2.5 py-1 rounded-md text-[10px] font-bold text-[#24754c] shadow-sm flex items-center gap-1.5">
                    <span>🏠</span> Owned home · Prop ID
                  </span>
                </div>
                <div className="p-6">
                  <h3 className="text-lg font-bold text-[#102645] mb-1">
                    18 Banksia Crescent
                  </h3>
                  <p className="text-[12px] text-[#68788e] mb-3">
                    Kenmore, Queensland 4069
                  </p>
                  <div className="text-[11px] text-[#68788e] flex items-center gap-1.5 mb-4 pb-3 border-b border-[#dfe6ef]">
                    <span>📁</span> 22 documents · <strong className="text-[#102645]">A living property record</strong>
                  </div>
                  <div className="flex items-center justify-between pt-1 text-[11px]">
                    <span className="text-[#8b641c] font-semibold">Handover ready to review</span>
                    <Link
                      href="/properties/TPH-KEN-018"
                      className="text-[#071d3b] font-bold hover:underline flex items-center gap-1"
                    >
                      <span>Open Prop ID</span>
              ...
              {/* Property 2: 7 Cedar Street (Saved / Buying Space) */}
              <article className="bg-white border border-[#dfe6ef] rounded-2xl overflow-hidden shadow-sm flex flex-col justify-between">
                <div className="relative h-44 bg-[#e4eaf0]">
                  <div className="w-full h-full bg-[#edf1f5] flex items-center justify-center text-[#8a97a7] text-3xl">
                    🏡
                  </div>
                  <span className="absolute bottom-3 left-3 bg-white px-2.5 py-1 rounded-md text-[10px] font-bold text-[#a44042] shadow-sm flex items-center gap-1.5">
                    <span>❤️</span> Buying · Private saved space
                  </span>
                </div>
                <div className="p-6">
                  <h3 className="text-lg font-bold text-[#102645] mb-1">
                  ...
                  <div className="text-[11px] text-[#68788e] flex items-center gap-1.5 mb-4 pb-3 border-b border-[#dfe6ef]">
                    <span>🔒</span> Your notes, documents &amp; conversations
                  </div>
                  <div className="flex items-center justify-between pt-1 text-[11px]">
                    <span className="text-[#68788e]">Only your own information</span>
                    <button
                      onClick={() => alert("7 Cedar Street: Saved property space for inspecting afternoon light and renovation notes.")}
                      className="text-[#071d3b] font-bold hover:underline flex items-center gap-1"
                    >
